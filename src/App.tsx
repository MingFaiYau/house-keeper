...
const App: React.FC = () => {
	...
	console.log('[App] settings.theme:', settings.theme, 'effectiveTheme:', effectiveTheme)
				...
				<Routes>
					...
					<Route
						...
						element={
							<ModuleGuard module='baby'>
								<BabyPageGuard>
									<PlaceholderPage title='新增活動' subtitle='Add Activity' />
								</BabyPageGuard>
							</ModuleGuard>
						}
					/>
					<Route
						...
						element={
							<ModuleGuard module='baby'>
								<BabyPageGuard>
									<PlaceholderPage title='歷史記錄' subtitle='History' />
								</BabyPageGuard>
							</ModuleGuard>
						}
					/>
					...
					<Route
						...
						element={
							<ModuleGuard module='baby'>
								<BabyPageGuard>
									<PlaceholderPage title='統計' subtitle='Statistics' />
								</BabyPageGuard>
							</ModuleGuard>
						}
					/>
